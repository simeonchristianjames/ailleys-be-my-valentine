      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations! You have completed our photo matched
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
        ...
        {step === 2 && (
          ...
          >
            ...
            >
              Will you be my Valentine babyyyyyy?
            </h2>
            <Image
              src="/sad_hamster.png"
              alt="Sad Hamster"
        ...
        {step === 3 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            Thank you for accepting, I love you babbyyyyy! 💕
